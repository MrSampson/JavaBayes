...
package edu.cmu.cs.javabayes.parsers.BIFv01;
...
/**
 * Definition of the Interchange Format class and its * variables. The
 * IFBayesNet ifbn contains the * parsed bayesian network.
 */
public class BIFv01 extends InterchangeFormat implements BIFv01Constants {
	...
	final private int[] jj_la1_0 = { 0x600, 0x600, 0x10000, 0x11000, 0x11000,
			0x120000, 0x120000, 0x20000000, 0x20000, 0x20000000, 0x801c000,
			0x801c000, 0x120000, 0x100000, };
